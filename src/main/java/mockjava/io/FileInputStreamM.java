 ...
 */
public
class FileInputStreamM extends InputStream
{
     ...
     */
    public FileInputStreamM(String name) throws FileNotFoundException {
     ...
     * @see        java.lang.SecurityManager#checkRead(java.lang.String)
     */
    public FileInputStreamM(File file) throws FileNotFoundException {
     ...
     */
    public FileInputStreamM(FileDescriptor fdObj) {
        SecurityManager security = System.getSecurityManager();
        if (fdObj == null) {
            throw new NullPointerException();
        }
...
//        fd.attach(this);
     ...
     */
    private static Object getFinalizer(FileInputStreamM fis) {
        Class<?> clazz = fis.getClass();
        while (clazz != FileInputStreamM.class) {
            try {
    ...
    static class AltFinalizer {
        private final FileInputStreamM fis;

        AltFinalizer(FileInputStreamM fis) {
            this.fis = fis;
        }
