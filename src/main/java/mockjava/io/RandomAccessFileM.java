...
public class RandomAccessFileM implements DataOutput, DataInput, Closeable {
     ...
     * @spec JSR-51
     */
    public RandomAccessFileM(String name, String mode)
     ...
     * @spec JSR-51
     */
    public RandomAccessFileM(File file, String mode)
            throws FileNotFoundException
    {
        this(file, mode, false);
    }

    private RandomAccessFileM(File file, String mode, boolean openAndDelete)
            throws FileNotFoundException
    {
